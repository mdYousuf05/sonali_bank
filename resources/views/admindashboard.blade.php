            ...
            -->
                ...
                <div class="w-full md:w-1/2 xl:w-1/3 p-6">
                    ...
                    <div class="w-full md:w-1/2 xl:w-1/3 p-6">
                        ...
                        <div class="bg-white border-transparent rounded-lg shadow-xl">
                            <div class="bg-gradient-to-b from-gray-300 to-gray-100 uppercase text-gray-800 border-b-2 border-gray-300 rounded-tl-lg rounded-tr-lg p-2">
                                <h2 class="font-bold uppercase text-gray-600">Field Agents Available</h2>
                            </div>
                            <div class="p-5">
                                <table class="w-full p-5 text-gray-700">
                                    ...
                                    <tr>
                                        ...
                                        <th class="text-left text-blue-900">Station</th>
                                        <th class="text-left text-blue-900">Designation</th>
                                    </tr>
                                    </thead>

                                    <tbody>
                                    <tr>
                                        <td>Mohammed Abu Hanif</td>
                                        <td>Location 1</td>
                                ...
                                <p class="py-2"><a href="#">See other available officers...</a></p>
